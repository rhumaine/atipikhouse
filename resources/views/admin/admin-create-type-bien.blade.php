           ...
           <div class="submit-address">
                ...
                @csrf
                    <div class="form-group @if ($errors->has('nameFr')) has-error @endif">
                        <label class="control-label">{!! __('general.type_name') !!} ({!! __('general.french') !!})</label>
                        <input type="text" class="input-text" name="nameFr" placeholder="{!! __('general.type_name') !!} ({!! __('general.french') !!})" value="" autofocus>
                    ...
                    <div class="form-group @if ($errors->has('nameEn')) has-error @endif">
                        <label class="control-label">{!! __('general.type_name') !!} ({!! __('general.english') !!})</label>
                        <input type="text" class="input-text" name="nameEn" placeholder="{!! __('general.type_name') !!} ({!! __('general.english') !!})" value="" autofocus>
