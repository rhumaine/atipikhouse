           ...
           <div class="submit-address">
                ...
                @csrf
                    <div class="form-group @if ($errors->has('nameFr')) has-error @endif">
                        ...
                        <input type="text" class="input-text" name="nameFr" placeholder="{!! __('general.equipment_name') !!} ({!! __('general.french') !!})" value="{{ $equipement[0]['libelle_fr_types_equipement'] }}" autofocus>
                    ...
                    <div class="form-group @if ($errors->has('nameEn')) has-error @endif">
                        ...
                        <input type="text" class="input-text" name="nameEn" placeholder="{!! __('general.equipment_name') !!} ({!! __('general.english') !!})" value="{{ $equipement[0]['libelle_en_types_equipement'] }}" autofocus>
                        <span class="help-block">@if ($errors->has('nameEn'))  {{ $errors->first('nameEn')}} @endif</span>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="id_types_equipement" value="{{ $equipement[0]['id_types_equipement'] }}">
